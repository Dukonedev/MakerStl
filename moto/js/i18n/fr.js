export default {
  ...
  "license.item3": "Soutenir cet outil ? Achetez sur <a href=\"\" target=\"_blank\" rel=\"noopener\"></a> ou faites un don sur <a href=\"\" target=\"_blank\" rel=\"noopener\">PayPal</a> / <a href=\"\" target=\"_blank\" rel=\"noopener\">Ko-fi</a>.",
  ...
  "license.item5": "<strong>Aucun support</strong> n'est fourni. L'auteur n'a aucune obligation de corriger des bogues, de répondre à des questions ou de mettre à jour cet outil. Cela dit, les rapports de bogues et les demandes de fonctionnalités sont toujours les bienvenus à <a href=\"mailto:\"></a>.",
  ...
  "license.item7": "Vous souhaitez licencier ou intégrer cet outil pour votre entreprise ou site web ? Contactez-nous à <a href=\"mailto:\"></a>.",
  "license.item8": "Code source disponible sur <a href=\"\" target=\"_blank\" rel=\"noopener\">GitHub</a>.",
  ...
  "imprint.info": "<br><br>Bahnhofstr. 2<br>88145 Hergatz<br>Allemagne",
  "imprint.contact": "E-mail : <a href=\"mailto:\"></a><br>Téléphone : <br><em>Le numéro de téléphone est réservé aux demandes légales/commerciales — pas pour le support.</em>",
  ...
  "imprint.privacyIntro": "<strong>Responsable du traitement</strong> (Verantwortlicher gem. Art. 4 Abs. 7 DSGVO) : , Bahnhofstr. 2, 88145 Hergatz, Allemagne.",
  ...
  "imprint.privacyExternal": "Ce site contient des liens vers des sites web externes (ex. : , PayPal, Ko-fi). Ces sites ont leurs propres politiques de confidentialité, sur lesquelles nous n'avons aucun contrôle.",
  ...
  "sponsor.title": "Merci d'utiliser AlphaApp de  !",
  "sponsor.body": "Cet outil est fourni <strong>entièrement gratuitement</strong> par .<br>Pendant que votre STL est en cours de traitement, pourquoi ne pas jeter un coup d'œil à la boutique qui nous aide à continuer à créer des choses sympas pour vous ?",
  "sponsor.visitStore": "🛒 Visiter ",
  "sponsor.donate": "💙 Faire un don sur PayPal",
  "sponsor.donateKofi": "☕ Soutenir sur Ko-fi",
  "sponsor.dontShow": "Ne plus afficher",
  "sponsor.closeAndContinue": "Fermer &amp; Continuer",
  "cta.store": "Soutenir cet outil ? Visitez <a href=\"\" target=\"_blank\" rel=\"noopener\"></a> ou faites un don sur <a href=\"\" target=\"_blank\" rel=\"noopener\">PayPal</a> / <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\">Ko-fi</a>",
