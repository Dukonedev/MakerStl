export default {
  ...
  "warnings.resolutionTooCoarse": "⚠ La resolución es más gruesa que 1/100 de la diagonal del cuadro delimitador del modelo — se perderán detalles finos. Reduce el valor para obtener resultados más finos.",
  ...
  "license.item3": "¿Quieres apoyar esta herramienta? Compra en <a href=\"\" target=\"_blank\" rel=\"noopener\"></a> o dona en <a href=\"\" target=\"_blank\" rel=\"noopener\">PayPal</a> / <a href=\"\" target=\"_blank\" rel=\"noopener\">Ko-fi</a>.",
  ...
  "license.item5": "<strong>No se proporciona soporte</strong>. El autor no tiene obligación de corregir errores, responder preguntas ni actualizar esta herramienta. Dicho esto, los informes de errores y solicitudes de funciones son siempre bienvenidos en <a href=\"mailto:\"></a>.",
  ...
  "license.item7": "¿Quieres licenciar o integrar esta herramienta para tu negocio o sitio web? Contáctanos en <a href=\"mailto:\"></a>.",
  "license.item8": "Código fuente disponible en <a href=\"\" target=\"_blank\" rel=\"noopener\">GitHub</a>.",
  ...
  "imprint.info": "<br><br>Bahnhofstr. 2<br>88145 Hergatz<br>Alemania",
  "imprint.contact": "Email: <a href=\"mailto:\"></a><br>Teléfono: 0175 2011824<br><em>El número de teléfono es exclusivamente para consultas legales/comerciales — no para soporte.</em>",
  ...
  "imprint.privacyIntro": "<strong>Responsable</strong> (Verantwortlicher gem. Art. 4 Abs. 7 DSGVO): , Bahnhofstr. 2, 88145 Hergatz, Alemania.",
  ...
  "imprint.privacyExternal": "Este sitio contiene enlaces a sitios web externos (p. ej., , PayPal, Ko-fi). Estos sitios tienen sus propias políticas de privacidad, sobre las cuales no tenemos control.",
  ...
  "sponsor.title": "¡Gracias por usar AlphaApp de !",
  "sponsor.body": "Esta herramienta es proporcionada <strong>completamente gratis</strong> por .<br>Mientras se procesa tu STL, ¿por qué no echas un vistazo a la tienda que nos ayuda a seguir creando cosas geniales para ti?",
  "sponsor.visitStore": "🛒 Visitar ",
  "sponsor.donate": "💙 Donar en PayPal",
  "sponsor.donateKofi": "☕ Apoyar en Ko-fi",
  "sponsor.dontShow": "No mostrar de nuevo",
  "sponsor.closeAndContinue": "Cerrar y continuar",
  "cta.store": "¿Quieres apoyar esta herramienta? Compra en <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\"></a> o dona en <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\">PayPal</a> / <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\">Ko-fi</a>",
