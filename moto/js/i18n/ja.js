export default {
  ...
  "license.item3": "このツールを支援しませんか？ <a href=\"\" target=\"_blank\" rel=\"noopener\"></a>でお買い物、または<a href=\"\" target=\"_blank\" rel=\"noopener\">PayPal</a> / <a href=\"\" target=\"_blank\" rel=\"noopener\">Ko-fi</a>で寄付できます。",
  "license.item4": "このツールは<strong>現状のまま</strong>提供され、いかなる種類の<strong>保証もありません</strong>。自己責任でご利用ください。",
  "license.item5": "<strong>サポートは提供されません</strong>。作者にはバグの修正、質問への回答、ツールの更新の義務はありません。ただし、バグ報告や機能リクエストは <a href=\"mailto:\"></a> までいつでも歓迎します。",
  "license.item6": "作者は、このツールの使用に起因する<strong>損害</strong>、データ損失、またはその他の問題について責任を負いません。",
  "license.item7": "このツールをビジネスやウェブサイトにライセンスまたは組み込みたい場合は、<a href=\"mailto:\"></a> までお問い合わせください。",
  "license.item8": "ソースコードは <a href=\"\" target=\"_blank\" rel=\"noopener\">GitHub</a> で公開されています。",
  "imprint.btn": "特定商取引法に基づく表記とプライバシー",
  "imprint.title": "特定商取引法に基づく表記とプライバシーポリシー",
  "imprint.sectionImprint": "運営者情報 (Impressum)",
  "imprint.info": "<br><br>Bahnhofstr. 2<br>88145 Hergatz<br>ドイツ",
  "imprint.contact": "メール: <a href=\"mailto:\"></a><br>電話: <br><em>電話番号は法律/ビジネスに関するお問い合わせ専用です — サポートには対応しておりません。</em>",
  ...
  "imprint.privacyIntro": "<strong>責任者</strong> (Verantwortlicher gem. Art. 4 Abs. 7 DSGVO): , Bahnhofstr. 2, 88145 Hergatz, ドイツ。",
  ...
  "imprint.privacyExternal": "このサイトには外部ウェブサイト（、PayPal、Ko-fiなど）へのリンクが含まれています。これらのサイトには独自のプライバシーポリシーがあり、当方では管理できません。",
  "imprint.privacyRights": "GDPRに基づき、<strong>アクセス、訂正、削除、処理の制限、データポータビリティ</strong>の権利、および監督機関に<strong>苦情を申し立てる</strong>権利があります。",
  "sponsor.title": " の AlphaApp をご利用いただきありがとうございます！",
  "sponsor.body": "このツールは  が<strong>完全無料</strong>で提供しています。<br>STLの処理中に、私たちがクールなものを作り続けるのを支えてくれるストアを覗いてみませんか？",
  "sponsor.visitStore": "🛒  を訪問",
  "sponsor.donate": "💙 PayPal で寄付",
  "sponsor.donateKofi": "☕ Ko-fi で支援",
  "sponsor.dontShow": "今後表示しない",
  "sponsor.closeAndContinue": "閉じて続行",
  "cta.store": "このツールを支援しませんか？ <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\"></a>でお買い物、または<a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\">PayPal</a> / <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\">Ko-fi</a>で寄付できます",
