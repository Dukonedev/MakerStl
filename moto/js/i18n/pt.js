export default {
  ...
  "license.item3": "Quer apoiar esta ferramenta? Compre na <a href=\"\" target=\"_blank\" rel=\"noopener\"></a> ou doe via <a href=\"\" target=\"_blank\" rel=\"noopener\">PayPal</a> / <a href=\"\" target=\"_blank\" rel=\"noopener\">Ko-fi</a>.",
  ...
  "license.item5": "<strong>Nenhum suporte</strong> é fornecido. O autor não tem obrigação de corrigir bugs, responder perguntas ou atualizar esta ferramenta. Dito isso, relatórios de bugs e pedidos de funcionalidades são sempre bem-vindos em <a href=\"mailto:\"></a>.",
  ...
  "license.item7": "Quer licenciar ou incorporar esta ferramenta para o seu negócio ou site? Entre em contato em <a href=\"mailto:\"></a>.",
  "license.item8": "Código-fonte disponível no <a href=\"\" target=\"_blank\" rel=\"noopener\">GitHub</a>.",
  ...
  "imprint.info": "<br><br>Bahnhofstr. 2<br>88145 Hergatz<br>Alemanha",
  "imprint.contact": "E-mail: <a href=\"mailto:\"></a><br>Telefone: <br><em>O número de telefone é exclusivamente para consultas legais/comerciais — não para suporte.</em>",
  ...
  "imprint.privacyIntro": "<strong>Responsável</strong> (Verantwortlicher gem. Art. 4 Abs. 7 DSGVO): , Bahnhofstr. 2, 88145 Hergatz, Alemanha.",
  ...
  "imprint.privacyExternal": "Este site contém links para sites externos (p. ex., , PayPal, Ko-fi). Esses sites têm suas próprias políticas de privacidade, sobre as quais não temos controle.",
  ...
  "sponsor.title": "Obrigado por usar o AlphaApp da !",
  "sponsor.body": "Esta ferramenta é fornecida <strong>totalmente grátis</strong> pela .<br>Enquanto seu STL está sendo processado, que tal dar uma olhada na loja que nos ajuda a continuar criando coisas legais para você?",
  "sponsor.visitStore": "🛒 Visitar ",
  "sponsor.donate": "💙 Doar via PayPal",
  "sponsor.donateKofi": "☕ Apoiar no Ko-fi",
  "sponsor.dontShow": "Não mostrar novamente",
  "sponsor.closeAndContinue": "Fechar e continuar",
  "cta.store": "Quer apoiar esta ferramenta? Compre na <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\"></a> ou doe via <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\">PayPal</a> / <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\">Ko-fi</a>",
