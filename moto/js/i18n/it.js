export default {
  ...
  "license.item3": "Vuoi sostenere questo strumento? Acquista su <a href=\"\" target=\"_blank\" rel=\"noopener\"></a> o fai una donazione su <a href=\"\" target=\"_blank\" rel=\"noopener\">PayPal</a> / <a href=\"\" target=\"_blank\" rel=\"noopener\">Ko-fi</a>.",
  ...
  "license.item5": "<strong>Non viene fornita alcuna assistenza</strong>. L'autore non ha alcun obbligo di correggere bug, rispondere a domande o aggiornare questo strumento. Detto questo, segnalazioni di bug e richieste di funzionalità sono sempre ben accette all'indirizzo <a href=\"mailto:\"></a>.",
  ...
  "license.item7": "Vuoi ottenere una licenza o incorporare questo strumento per la tua attività o il tuo sito web? Contattaci all'indirizzo <a href=\"mailto:\"></a>.",
  "license.item8": "Codice sorgente disponibile su <a href=\"\" target=\"_blank\" rel=\"noopener\">GitHub</a>.",
  ...
  "imprint.info": "<br><br>Bahnhofstr. 2<br>88145 Hergatz<br>Germania",
  "imprint.contact": "E-mail: <a href=\"mailto:\"></a><br>Telefono: <br><em>Il numero di telefono è riservato esclusivamente a richieste legali/commerciali — non per l'assistenza. </em>",
  ...
  "imprint.privacyIntro": "<strong>Titolare del trattamento</strong> (Verantwortlicher gem. Art. 4 Abs. 7 DSGVO): , Bahnhofstr. 2, 88145 Hergatz, Germania.",
  ...
  "imprint.privacyExternal": "Questo sito contiene link a siti web esterni (ad es. , PayPal, Ko-fi). Questi siti hanno le proprie politiche sulla privacy, sulle quali non abbiamo alcun controllo.",
  ...
  "sponsor.title": "Grazie per aver scelto AlphaApp di !",
  "sponsor.body": "Questo strumento è offerto <strong>completamente gratis</strong> da .<br>Mentre il tuo file STL viene elaborato, perché non dai un'occhiata al negozio che ci aiuta a continuare a creare cose fantastiche per te?",
  "sponsor.visitStore": "🛒 Visita ",
  "sponsor.donate": "💙 Dona su PayPal",
  "sponsor.donateKofi": "☕ Supporta su Ko-fi",
  "sponsor.dontShow": "Non mostrare più questo messaggio",
  "sponsor.closeAndContinue": "Chiudi e continua",
  "cta.store": "Vuoi sostenere questo strumento? Acquista su <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\"></a> o dona su <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\">PayPal</a> / <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\">Ko-fi</a>",
