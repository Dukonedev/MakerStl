...
const fragmentShader = /* glsl */`
  ...
  void main() {
    ...
    vec3 greyBase      = vec3(0.55, 0.55, 0.55);
    ...
    // Lit grey (identical for textured and masked surfaces)
    vec3 litGrey = greyBase * 0.55
                 + greyBase * diff1 * vec3(1.00, 0.96, 0.88) * 0.55
                 + greyBase * diff2 * vec3(0.80, 0.60, 0.50) * 0.15
                 + vec3(spec);
    ...
    vec3 color = mix(litGrey, litMask, maskEffect);
